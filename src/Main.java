		...
		while (true) {
			...
			if (commandMenu == 2) {
				...
				System.out.println("Создан текст, путем расшифровки по заданному ключу.\n" +
						"Требуется сохранить данный текст файл c расширением - \".txt\" ");
				ReadWriteTextFileNIO.writeNewTextFile(encryptionText);
			}
			if (commandMenu == 3) {
				System.out.print("-----------------------------------------------------------------------------\n" +
			...
			if (commandMenu == 4) {
				System.out.print("-----------------------------------------------------------------------------\n" +
						"Вы находитесь в пункте меню:\n" +
						"4 - Сравнение и поиск схожих слов, в зашифрованном  тексте," +
						" с текстовым файлом, выбранного пользователем.\n" +
						"-----------------------------------------------------------------------------\n");
